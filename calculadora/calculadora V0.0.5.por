programa
{
    ...
    funcao mostrarDisplay(real valor)
    {
        ...
        escreva("|_log.|_fat.|_pot.|_raiz_________|\n")
        escreva("|________________________________|\n")
    }
    ...
    funcao inicio()
    {
        ...
        faca
        {
            ...
            escreva("9. Radiciação (raiz quadrada)\n")
            escreva("0. Sair\n")
            ...
            escolha(opcao)
            {
                ...
                // ===== NOVA FUNÇÃO: RADICIAÇÃO =====
                caso 9:
                    se(vet[0] == 0.0)
                    {
                        escreva("Digite o número para calcular a raiz: ")
                        leia(vet[1])
                    }
                    senao
                    {
                    ...
                    se(vet[1] < 0)
                    {
                        escreva("Erro: raiz quadrada de número negativo não existe!\n")
                    }
                    senao
                    {
                        vet[0] = mat.raiz(vet[1], 2)
                        mostrarDisplay(vet[0])
                    }
                pare
